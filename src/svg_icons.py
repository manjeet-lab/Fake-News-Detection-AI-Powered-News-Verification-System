"""
=============================================================================
  SVG ICON SYSTEM — REUSABLE INLINE SVG ICON GENERATOR
=============================================================================

Provides pixel-perfect, modern Lucide / Heroicons style SVG icons for the app.
All icons are strictly SVG strings without Unicode emojis.
"""

# Dictionary of clean 24x24 SVG path specifications
_ICON_PATHS = {
...
def get_svg(name: str, size: int = 20, color: str = "currentColor", stroke_width: float = 2.0, style_extra: str = "") -> str:
    """
    Returns an inline SVG string for the specified icon name.
    
    Args:
        name: Key name from _ICON_PATHS (e.g. 'shield', 'search', 'check-circle')
        size: Width & Height in pixels
        color: CSS color string (e.g. '#7C3AED', 'currentColor', '#10B981')
        stroke_width: SVG stroke width
        style_extra: Additional inline CSS styles (e.g. 'vertical-align: middle; margin-right: 6px;')
        
    Returns:
        HTML inline SVG string.
    """
    path = _ICON_PATHS.get(name.lower(), _ICON_PATHS["info"])
    
    svg_html = (
        f'<svg xmlns="http://www.w3.org/2000/svg" width="{size}" height="{size}" '
        f'viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="{stroke_width}" '
        f'stroke-linecap="round" stroke-linejoin="round" '
        f'style="display: inline-block; vertical-align: -0.125em; flex-shrink: 0; {style_extra}">'
        f'{path}'
        f'</svg>'
    )
    return svg_html
